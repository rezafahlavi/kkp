...
public class lap_angsuran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Data Ansuran Simpan Pinjam PT Prima Karya Berjaya Banten");
    ...
    private void bcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcetakActionPerformed
        try{
            String namaFile = "src/laporan/lap_angsuran.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lap_angsuran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
